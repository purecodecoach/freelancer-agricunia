                ...
                <div className="xl:w-2/5 lg:w-2/5 bg-green-600 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
                    <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
                        ...
                        <div className="flex pb-4 items-center">
                            ...
                            <p className="pl-4 text-white text-base">+ 234 8176 960 676</p>
                        </div>
                        <div className="flex items-center">
                            ...
                            <p className="pl-4 text-white text-base">info@agricunia.com</p>
                        </div>
                    ...
                    <form id="contact" className="bg-white py-4 px-8 rounded-tr rounded-br">
                        ...
                        <div className="block xl:flex w-full flex-wrap justify-between mb-6">
                            <div className="w-2/4 max-w-xs mb-6 xl:mb-0">
                                <div className="flex flex-col">
                                    ...
                                    <input required id="full_name" name="full_name" type="text" className="focus:outline-none  font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder />
                                </div>
                            </div>
                            <div className="w-2/4 max-w-xs xl:flex xl:justify-end">
                                <div className="flex flex-col">
                                    ...
                                    <input required id="email" name="email" type="email" className="focus:outline-none  font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder />
                                </div>
                            </div>
                        </div>
                        <div className="flex w-full flex-wrap">
                            <div className="w-2/4 max-w-xs">
                                <div className="flex flex-col">
                                    ...
                                    <input required id="phone" name="phone" type="tel" className="focus:outline-none  font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder />
                                </div>
                            </div>
                        </div>
                        <div className="w-full mt-6">
                            <div className="flex flex-col">
                                ...
                                <textarea placeholder name="message" className="border-gray-300 border mb-4 rounded py-2 text-sm outline-none resize-none px-3 " rows={8} id="message" defaultValue={""} />
                            </div>
                            <button type="submit" className="focus:outline-none bg-green-700 transition duration-150 ease-in-out hover:bg-green-600 rounded text-white px-8 py-3 text-sm leading-6">
                                Submit
                            </button>
                        </div>
                    </form>
